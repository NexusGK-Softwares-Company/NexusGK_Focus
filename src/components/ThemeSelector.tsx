...
export const themes: ThemeConfig[] = [
  ...
  },
  {
    ...
    primary: '#00FF00',
    secondary: '#00CC00',
    backgroundImage: 'https://media.giphy.com/media/3o7TKP9ln2Dr6ze6f6/giphy.gif',
  },
  {
    id: 'code-dark',
    name: 'Dark Code',
    gradient: 'from-gray-950 via-slate-950 to-gray-950',
    primary: '#61DAFB',
    secondary: '#4FC3F7',
  ...
  },
  {
    ...
    primary: '#FF00FF',
    secondary: '#00FFFF',
    backgroundImage: 'https://media.giphy.com/media/26tn33aiTi1jkl6H6/giphy.gif',
  },
  {
    id: 'hacker',
    name: 'Hacker',
    gradient: 'from-black via-emerald-950 to-black',
    primary: '#00FF41',
    secondary: '#00D939',
    backgroundImage: 'https://media.giphy.com/media/RbDKaczqWovIugyJmW/giphy.gif',
  },
  {
    id: 'workspace',
    name: 'Dev Workspace',
  ...
  },
  {
    ...
    primary: '#00BFFF',
    secondary: '#1E90FF',
    backgroundImage: 'https://media.giphy.com/media/3oKIPic2BnoVZkRla8/giphy.gif',
  },
  {
    id: 'react',
    name: 'React Blue',
    ...
    primary: '#61DAFB',
    secondary: '#53C1DE',
    backgroundImage: 'https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=1920&q=80',
  },
  {
    id: 'coffee-code',
    name: 'Coffee & Code',
    gradient: 'from-amber-950 via-brown-950 to-amber-950',
    primary: '#D4A574',
    secondary: '#F4A261',
    backgroundImage: 'https://images.unsplash.com/photo-1484788984921-03950022c9ef?w=1920&q=80',
  },
];
